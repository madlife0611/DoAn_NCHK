...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <button type="button" class="btn btn-default"><a href="index.php?controller=products">Trở lại <i
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="tensp" name="tensp"
                        value="<?php echo isset($record->tensp) ? $record->tensp : ""; ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="gianhap" name="gianhap"
                        value="<?php echo isset($record->gianhap) ? $record->gianhap : ""; ?>">
                </div>
                <div class="form-group">
                    <label>Ngày nhập</label>
                    <div class="input-group date">
                        <input type="date" name="ngaynhap"
                            value="<?php echo isset($record->ngaynhap) ? $record->ngaynhap : ""; ?>"
                            class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group date">
                        <input type="date" class="form-control" name="hanbaotri"
                            value="<?php echo isset($record->hanbaotri) ? $record->hanbaotri : ""; ?>">
                    </div>
                </div>
                <div class="form-group clearfix">
                    <label>Trạng thái</label>
                    <div class="icheck-primary d-inline">
                        <input type="radio" id="radioPrimary1" name="trangthai" value="0" checked>
                        <label for="radioPrimary1">
                            Tự do
                        </label>
                    </div>
                    <div class="icheck-primary d-inline">
                        <input type="radio" id="radioPrimary2" name="trangthai" value="1">
                        <label for="radioPrimary2">
                            Đang sử dụng
                        </label>
                    </div>
                    <div class="icheck-primary d-inline">
                        <input type="radio" id="radioPrimary3" name="trangthai" value="2">
                        <label for="radioPrimary3">
                            Đang bảo trì
                        </label>
                    </div>
                    <div class="icheck-primary d-inline">
                        <input type="radio" id="radioPrimary4" name="trangthai" value="3">
