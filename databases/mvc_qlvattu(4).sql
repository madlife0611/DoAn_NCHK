...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 27, 2023 lúc 09:18 PM
...
(1, 'Bông y tế', 'b1.PNG', '100gr', 100, 2000, '2022-10-28', '2023-07-31', 10, 1, 1, '', 0, 1, 1, 1),
(7, 'Bông viên', 'b2.PNG', '50gr', 100, 1000, '2022-11-21', '2023-05-10', 10, 1, 3, '', 0, 1, 1, 1),
(8, 'Băng thun y tế', 'b3.PNG', 'Size: 0,1m x 3m', 100, 3000, '2022-11-21', '2023-07-21', 8, 1, 2, '', 0, 1, 1, 1),
(9, 'Băng AID FIRST', 'b4.PNG', 'Hộp 100 cái', 100, 20000, '2022-11-21', '2023-06-30', 0, 1, 1, '', 0, 1, 1, 2),
...
(16, 'Cồn 75 độ', 'k3.PNG', '100ml', 100, 2000, '2022-12-09', '2023-07-31', 0, 0, 1, '', 0, 1, 1, 0),
...
(31, 'Bộ đồ y tế', 'v1.PNG', 'Đầy đủ quần áo, găng tay, khẩu trang', 100, 25000, '2022-11-21', '2023-07-31', 0, 1, 1, '', 0, 1, 3, 2),
...
(36, 'Máy đo nhiệt', 'v6.PNG', 'Sử dụng pin', 100, 30000, '2022-11-21', '2023-07-31', 0, 0, 0, '', 0, 3, 3, 3),
(37, 'Cố định cổ', 'v9.PNG', 'Màu trắng', 100, 10000, '2022-11-21', '2023-07-31', 0, 0, 0, '', 0, 1, 3, 2),
(38, 'Trùm tóc', 'v8.PNG', 'Dùng 1 lần', 100, 500, '2022-11-21', '2023-07-31', 0, 0, 1, '', 0, 1, 3, 2),
(39, 'Ống thông', 'v7.PNG', 'Kim loại', 100, 10000, '2022-11-21', '2023-07-31', 0, 0, 1, '', 0, 1, 3, 4),
...
(42, 'Ống lưu trữ lạnh tế bào', '42.JPG', '5ml', 27, 1000, '2022-12-08', '2023-07-31', 10, 1, 1, '', 0, 2, 4, 1),
...
(45, 'Kim châm cứu', 'k1.JPG', '10 kim 1 gói', 25, 5000, '2022-12-08', '2023-07-31', 0, 0, 2, '', 0, 2, 5, 1),
...
(53, 'Máy siêu âm', 'm3.JPG', 'USA', 1, 35000000, '2022-12-08', '2024-07-31', 0, 0, 2, '', 0, 3, 10, 1),
(54, 'Máy siêu âm S2', 'm4.JPG', 'Japan', 1, 30000000, '2022-12-08', '2023-04-30', 0.729933, 4, 0, '', 360003, 3, 10, 2),
(55, 'Máy chụp X quang', 'm5.JPG', 'USA', 1, 40000000, '2022-12-08', '2024-05-31', 0, 0, 0, '', 0, 3, 10, 2),
(56, 'Máy chụp cát lớp', 'm6.JPG', 'USA', 1, 100000000, '2022-12-08', '2024-06-30', 0, 0, 1, '', 0, 3, 10, 2),
(61, 'test 112122', 'IMG_4579.JPG', 'Cái này để test thôi', 1, 2147483647, '2023-04-23', '2023-04-30', 0, 0, 0, '', 0, 2, 10, 2);
...
INSERT INTO `requests` (`request_id`, `ngaylap`, `tongtien`, `trangthai`, `ngayxacnhan`, `matk`, `matk_admin`) VALUES
(1, '2023-04-22 11:50:31', 10000, 1, '2023-04-23 21:47:17', 2, 3),
(2, '2023-04-22 11:51:06', 10000, 1, '2023-04-22 21:06:48', 2, 3),
(3, '2023-04-23 21:48:47', 30010000, 1, '2023-04-23 21:52:31', 2, 3),
(4, '2023-04-23 22:06:27', 1000, 1, '2023-04-24 00:22:45', 2, 3),
(5, '2023-04-24 00:36:25', 40040000, 0, '', 2, 0),
(6, '2023-04-24 21:12:00', 30021000, 0, '', 2, 0),
(7, '2023-04-24 21:31:17', 20021000, 0, '', 2, 0);
...
--
ALTER TABLE `changelog`
  MODIFY `macl` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=92;
...
--
ALTER TABLE `maintenances`
  MODIFY `mabt` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `requestdetails`
  MODIFY `request_detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT cho bảng `requests`
--
ALTER TABLE `requests`
  MODIFY `request_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
