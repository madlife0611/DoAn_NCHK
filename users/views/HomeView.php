    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-success">
          <div class="inner">
            <h3><?php echo $TotalType3Products = $this->modelTotalType3Products();
                ?></h3>

            <p>Trang thiết bị đang có</p>
          </div>
          <div class="icon">
      ...
      <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-warning">
          <div class="inner">
            <h3><?php echo $TotalRequestsOn7Days = $this->modelTotalRequestsOn7Days();
                ?></h3>

            <p>Yêu cầu trong tuần qua</p>
          </div>
          <div class="icon">
