...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 22, 2023 lúc 08:39 PM
...
(18, 'Bình xịt khử trùng', 'k5.PNG', '650ml', 100, 10000, '2022-11-21', '2023-07-31', 0, 0, 0, 2, 1, 2),
...
(61, 'test 112122', 'IMG_4579.JPG', 'Cái này để test thôi', 1, 2147483647, '2023-04-23', '2023-06-25', 0, 0, 1, 2, 10, 2);
...
(1, '2023-04-22 11:50:31', 10000, 0, '0', 2, 0),
...
--
ALTER TABLE `requestdetails`
  MODIFY `request_detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
